...
bibKeys = yaml.load(open("bibtex_Habsburg_new.yml"), Loader = yaml.FullLoader)
...
def bibLoad(bibTexFile):
    ...
    with open("Habsburg.bib", "r", encoding="utf8") as f1:
...
def convertToCSV(bibTexFile):
    ...
    for k,v in data.items():
        ...
        tempVal = "\t".join([citeKey, rType, author, title, year])
